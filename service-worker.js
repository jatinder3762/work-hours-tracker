const CACHE='my-tracker-v24';
const ASSETS=['./','./index.html','./about.html','./terms.html','./privacy.html','./help.html','./info.css','./style.css','./data-errors.js','./auth-ui.js','./homepage-ui.js','./account-ui.js','./shift-ui.js','./period-share.js','./pay-ui.js','./app.js','./app-core.js','./manifest.json','./icon.svg'];
