const CACHE='my-tracker-v20';
const ASSETS=['./','./index.html','./style.css','./data-errors.js','./auth-ui.js','./homepage-ui.js','./account-ui.js','./shift-ui.js','./period-share.js','./pay-ui.js','./app.js','./app-core.js','./manifest.json','./icon.svg'];
