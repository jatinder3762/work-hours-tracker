const CACHE='my-tracker-v19';
const ASSETS=['./','./index.html','./style.css','./data-errors.js','./auth-ui.js','./account-ui.js','./shift-ui.js','./period-share.js','./pay-ui.js','./app.js','./app-core.js','./manifest.json','./icon.svg'];
